...
import com.simplesys.io.ResourceAdapting.ReadableChannelAdapter

/**
 * A ManagedResource for accessing and using InputStreams.  Class can be created using the [[com.simplesys.io.Resource]] object.
 */
